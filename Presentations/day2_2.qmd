...
format: 
  revealjs:
    ...
    nocite: |
      @lima_genomes_2023, @de_los_campos_whole-genome_2013, @jarquin_reaction_2014, @perez_genome-wide_2014
...
* Lesser number of iterations required
...
## Multi-environment GS model {.custom1 .scrollable}
...
```{r}
#| code-fold: true
col_fun = colorRamp2(c(min(X_ge), 0, max(X_ge)), c("blue4", "white", "green4"))
Heatmap(
  X_ge,
  show_row_dend = FALSE,
  show_row_names = FALSE,
...
#| fig-height: 3
library(coda)
trace_varE = read.table("../complete_met2_varE.dat")[,1]
trace_varG = read.table("../complete_met2_ETA_hyb_varU.dat")[,1]
trace_varGEI = read.table("../complete_met2_ETA_gei_varU.dat")[,1]
...
![](C:/Users/saulo/OneDrive/Palestras/Misc/CV1_CV2.png){width="60%" fig-align="center"}
